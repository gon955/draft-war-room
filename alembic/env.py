...
# TODO (Phase 1): point autogenerate at the schema and read the URL from the
# environment, once warroom/db.py defines Base and warroom/models.py fills it:
#
#     import warroom.models   (with a lint exemption for the unused import)
